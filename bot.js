...
client.on('ready', () => {
  console.log(`Logged in as ${client.user.tag}!`);
   client.user.setActivity("القرآن الكريم",{type: 'WATCHING'})
});
// CODE BY KAHRBAA كههربا
const { Client } = require('discord.js');
const ytdl  = require('ytdl-core');// CODE BY KAHRBAA كههربا
const url = 'https://www.youtube.com/watch?v=mqgZxUSA1tU'; // هنا فديو الخاص ب القرأن الكريم كامل // CODE BY KAHRBAA كههربا
